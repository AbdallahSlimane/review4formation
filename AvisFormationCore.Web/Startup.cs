using AvisFormationCore.Web.Data;
using AvisFormationCore.Web.Middlewares;
using Data;
...
namespace AvisFormationCore.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MonDbContext>(options =>options.UseSqlServer(
                    Configuration.GetConnectionString("DefaultConnection")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseMiddleware<RedirectionPermanenteMiddleware>();
        }
    }
}
